...
#line 1121 "parser.tab.cpp"
  ...
  case 13: /* expression: expression T_EXPON expression  */
#line 79 "parser.y"
                                        { (yyval.value) = pow((yyvsp[-2].value),(yyvsp[0].value));  std::cout << (yyvsp[-2].value) << " ^ " << (yyvsp[0].value) << " = " << pow((yyvsp[-2].value),(yyvsp[0].value)) << "\n"; }
