...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_NUBMER = 3,                   /* T_NUBMER  */
  YYSYMBOL_T_INDEX = 4,                    /* T_INDEX  */
  YYSYMBOL_T_EOL = 5,                      /* T_EOL  */
  YYSYMBOL_T_EXIT = 6,                     /* T_EXIT  */
  YYSYMBOL_YYACCEPT = 7,                   /* $accept  */
  YYSYMBOL_programm = 8,                   /* programm  */
  YYSYMBOL_9_1 = 9,                        /* $@1  */
  YYSYMBOL_10_2 = 10                       /* $@2  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "T_NUBMER", "T_INDEX",
  "T_EOL", "T_EXIT", "$accept", "programm", "$@1", "$@2", YY_NULLPTR
};
